...
class GovernmentProject(models.Model):
    ...
    total_project_cost = models.FloatField(
        null=True,
        blank=True,
        help_text='The Total Project Cost on record'
    )
    ...
    implementation_period = models.DurationField(
        null=True,
        blank=True,
        help_text='Duration of the project'
    )
    ...
    implementation_from = models.DateTimeField(
        null=True,
        blank=True,
        help_text='Start datetime of implementation'
    )
    implementation_to = models.DateTimeField(
        null=True,
        blank=True,
        help_text='End datetime of implementation'
    )
...
class ICCDate(models.Model):
    timestamp = models.DateTimeField(
        help_text='Datetime of ICCDate instance'
    )
    description = models.CharField(
        max_length=180,
        help_text='Optional: Short text describing the date'
    )
